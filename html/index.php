                  ...
                  <div class="lang_box ">
                     <a href="#" title="Language" class="nav-link" data-toggle="dropdown" aria-expanded="true">
                        ...
                        if (isset($_SESSION['name'])) {
                           ...
                           $name = $_SESSION['name'];
                           echo ' <i class="fa-solid fa-user"> ' . $name . '</i>';
                        }
                        ?>
                     ...
                     if (!isset($_SESSION["isUserLogin"])) {
                        echo '<a href="../auth/login.php" class="dropdown-item">
                           
LOGIN
</a>
<a href="../auth/signup.php" class="dropdown-item">
...
SIGNUP
   ...
   <div class="fashion_section">
      ...
      <div class="box_main">
         <h4 class="shirt_text">' . $row['p_name'] . '</h4>
         <p class="price_text">Price <span style="color: #262626;">$ ' . $row['p_price'] . '</span></p>
         <div class="tshirt_img"><img src="' . $row['p_image'] . '"></div>
         <div class="btn_main">
